...
```bash
git clone https://github.com/Lavakumar1729/PolyPredictEdge.git
...
Instead of "what's the probability?", Claude is asked: _"Does this news make the market MORE likely to resolve YES, MORE likely to resolve NO, or is it NOT RELEVANT?"_
...
## The Edge Nobody Is Watching

Polymarket is a $1B+ prediction market running on a public blockchain with open APIs, free WebSocket feeds, and thousands of resolved markets as labeled training data.

Most of it is efficiently priced. But the long tail — markets under $500K, niche geopolitical calls, obscure regulatory decisions — gets priced by a handful of people who happened to notice them.

That's the gap this bot lives in.

**The math is simple:**

- A Reuters headline drops
- A niche market is still sitting at 45%
- True probability just became 80%
- That gap is open for ~60 seconds

Not because you know more. Because you _read faster._

> Polymarket is where equity markets were in 2003. The window is open. This is the software that crawls through it.
